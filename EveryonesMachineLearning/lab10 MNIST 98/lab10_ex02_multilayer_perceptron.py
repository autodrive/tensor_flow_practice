...
dropout https://www.youtube.com/watch?v=ls8jHqRnEQk#t=8m17s
"""
...
weights = {
    ...
    'h3': tf.get_variable("W3", shape=[n_hidden_2, n_hidden_3], initializer=xavier_init(n_hidden_2, n_hidden_3)),
    'h4': tf.get_variable("W4", shape=[n_hidden_3, n_hidden_4], initializer=xavier_init(n_hidden_3, n_hidden_4)),
    'out': tf.get_variable("W5", shape=[n_hidden_4, n_classes], initializer=xavier_init(n_hidden_4, n_classes)),
}
biases = {
